...
console.log(maxSubarraySum([100, 200, 300, 400], 2), 'Should be 700')

console.log(maxSubarraySum([1, 4, 2, 10, 23, 3, 1, 0, 20], 4), 'Should be 39')

console.log(maxSubarraySum([-3, 4, 0, -2, 6, -1], 2), 'Should be 5')

console.log(maxSubarraySum([3, -2, 7, -4, 1, -1, 4, -2, 1], 2), 'Should be 5')

console.log(maxSubarraySum([2, 3], 3), 'Should be null')
