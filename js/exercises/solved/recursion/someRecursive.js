/*
  ...
  in the array returns true when passed to the 
...
console.log(someRecursive([1, 2, 3, 4], isOdd), "Should be true");

console.log(someRecursive([4, 6, 8, 9], isOdd), "Should be true");

console.log(someRecursive([4, 6, 8], isOdd), "Should be false");
